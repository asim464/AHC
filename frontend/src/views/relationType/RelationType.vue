<template>
  ...
  import ComplaintTypeCreateModal from "@/components/relationType/RelationTypeCreateModal.vue";
  import ComplaintTypeEditModal from "@/components/relationType/RelationTypeEditModal.vue";
