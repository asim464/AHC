<template>
  ...
  import ComplaintTypeCreateModal from "@/components/ranks/RanksCreateModal.vue";
  import ComplaintTypeEditModal from "@/components/ranks/RanksEditModal.vue";
